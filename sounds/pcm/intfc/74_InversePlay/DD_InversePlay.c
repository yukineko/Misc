...
//************************************************************************//
        ...
        DataPoint=DataPoint-2*ch;                           // 読み込み位置を更新（戻る方向）
        if(DataPoint<=36)break;                             // ヘッダ位置まで戻ると終了
        fseek(f1, DataPoint, SEEK_SET);                     // 次のサンプル取得位置に移動しておく
