...
#define Fs_out   Fs*1.7                                             // 出力サンプリング周波数
...
int main(void){
    ...
    WAVEFORMATEX wave_format_out = {WAVE_FORMAT_PCM,                // PCM
                                 1,                                 // モノラル
                                 Fs_out,                            // サンプリング周波数
                                 2*Fs_out,                          // 1秒あたりの音データサイズ（byte）
                                 2,                                 // 音データの最小単位（2byte）
                                 16,                                // 量子化精度（16bit）
                                 0                                  // オプション情報のサイズ（0byte
                                };
...
//************************************************************************//
    ...
    waveOutOpen(&out_hdl, 0, &wave_format_out, 0, 0, CALLBACK_NULL);// 出力(再生)デバイスオープン
