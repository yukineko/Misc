...
//************************************************************************//
    ...
    int      tau;                                                   // ビブラート遅延量
    double   d, r;                                                  // ビブラート用変数
    double   depth;                                                 // ビブラートの深さ
    long int l;                                                     // ビブラート管理用時刻
...
//************************************************************************//
            ...
            ////////////////////////////////////////////////////
                    ...
                    tau  = d + depth * sin(2.0*M_PI*r*l/(double)Fs);// 時変遅延量
                    y[t] = s[t] + s[(t-tau+MEM_SIZE)%MEM_SIZE];     // 現在の入力と遅延入力を加算
                    l    = (l+1)%(10*Fs);                           // ビブラート用の時刻管理
