...
//************************************************************************//
    ...
    double   gain;                                                  // 入力に対するゲイン
    double   Level;                                                 // 変換後の信号の最大値
    ///////////////////////////////
    //                           //
    //      変数の初期設定       //
    //                           //
...
//************************************************************************//
            ...
            ////////////////////////////////////////////////////
                    ...
                    s[t] = gain*fabs(s[t]);                         // 入力の絶対値を定数倍する
                    if(s[t]> 1.0) s[t] =  1.0;                      // 上限を 1とする
                    if(s[t]<-1.0) s[t] = -1.0;                      // 下限を-1とする
                    y[t]=s[t]*Level;                                // 変換後の信号の最大値を調整
